...
def customer_mart_calculation_table_write(final_customer_data_mart_df):
    ...
    final_customer_data_mart_table = final_customer_data_mart_df.withColumn("sales_date_month",
    ...
    db_writer.write_dataframe(final_customer_data_mart_table,config.customer_data_mart_table)
